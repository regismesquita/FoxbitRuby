...
RSpec.describe 'Order' do
  describe '.order_from_api' do
    before(:each) do
      @orders = Order.orders_from_api(bids: [[2000,0.01,1],[1000,0.02,2]], asks: [[1200,0.01,3],[1300,0.02,4]])
    end
    it 'should receive receive bids and asks from api and return an array of orders' do
  ...
  describe '#fiat_value' do
    it 'should return the fiat value of the order' do
  ...
  describe '#satoshis' do
    it 'should return the bitcoin amount in satoshis' do
